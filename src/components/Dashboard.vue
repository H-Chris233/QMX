              ...
              >
                ...
                <div class="renew-action">
                  ...
                  <button
                    ...
                    :disabled="
                      loading || !(Number(extendDaysMap[student.uid] || 0) > 0)
                    "
                  >
                    <CreditCard :size="12" />
                    续费
...
import { ref, reactive, onMounted, onUnmounted, type Ref, computed } from 'vue';
...
const loadDashboardData = async (forceRefresh = false): Promise<void> => {
  ...
  try {
    ...
    const membershipPromise = studentStore.fetchExpiringStudents(7)
      .then(result => {
